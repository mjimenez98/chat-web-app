            ...
            <div id="chat-window" class="overflow-auto chat-border-color">
                <table class="table table-striped">
                    ...
                    <%
                        ...
                        if (apiResponse == null) {
                            apiResponse = (String) session.getAttribute("apiResponse");
                            session.setAttribute("apiResponse", "");
                        }
                        ...
                        <td>
                            <div class="container">
                                <div class="row justify-content-between">
                                    <div class="col-3">
                                        <p class="font-weight-light"><%= message.getUser() %>
                                        </p>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <p class="font-weight-normal text-wrap"><%= message.getMessage() %>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div>
                    <p class="font-weight-bold"><%=apiResponse%>
                    </p>
                </div>
            </div>
        </div>
